...
func TestExpiry(t *testing.T) {
	...
	t.Run("with no expiry", func(t *testing.T) {
		option, timestamp := command.ExpiryTimestamp(clock, store.ExpiryOptionNone, 0)
	...
	t.Run("with keep TTL", func(t *testing.T) {
		option, timestamp := command.ExpiryTimestamp(clock, store.ExpiryOptionExpiryKeepTTL, 0)
	...
	t.Run("with expiry in unix milliseconds should return timestamp as given", func(t *testing.T) {
		option, timestamp := command.ExpiryTimestamp(clock, store.ExpiryOptionExpiryUnixTimeInMilliseconds, 42_123)
	...
	t.Run("with expiry in unix seconds should return timestamp in milliseconds", func(t *testing.T) {
		option, timestamp := command.ExpiryTimestamp(clock, store.ExpiryOptionExpiryUnixTimeInSeconds, 42)
	...
	t.Run("with expiry of milliseconds in the future should return timestamp in milliseconds", func(t *testing.T) {
		option, timestamp := command.ExpiryTimestamp(clock, store.ExpiryOptionExpiryMilliseconds, 42_123)
	...
	t.Run("with expiry of seconds in the future should return timestamp in milliseconds", func(t *testing.T) {
		option, timestamp := command.ExpiryTimestamp(clock, store.ExpiryOptionExpirySeconds, 42)
